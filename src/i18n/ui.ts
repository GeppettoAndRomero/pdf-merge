...
export const ui = {
  en: {
    ...
    uploadSubtitle: 'Choose the PDFs to merge.',
    dropClick: 'Click to choose files',
    dropOr: 'or drop files anywhere on the page',
    dropSupported: 'PDF files',
    settingsButton: 'Settings',
    mergeButton: 'Merge PDFs', merging: 'Merging…', moveUp: 'Move up', moveDown: 'Move down', removeFile: 'Remove',
    ...
    dzDropSub: 'Drop PDFs to merge them',
  ...
  ja: {
    ...
    uploadSubtitle: '結合する PDF を選んでください。',
    dropClick: 'クリックして選択',
    dropOr: 'またはページ上にドロップ',
    dropSupported: 'PDF ファイル',
    settingsButton: '設定',
    mergeButton: 'PDF を結合', merging: '結合中…', moveUp: '上へ', moveDown: '下へ', removeFile: '削除',
  ...
  zh: {
    // ConversionManager
    uploadHeading: '选择文件',
    uploadSubtitle: '选择要合并的 PDF。',
    dropClick: '点击选择文件',
    dropOr: '或把文件拖到页面任意位置',
    dropSupported: 'PDF 文件',
    settingsButton: '设置',
    mergeButton: '合并 PDF', merging: '正在合并…', moveUp: '上移', moveDown: '下移', removeFile: '移除',
  ...
  de: {
    ...
    uploadSubtitle: 'Wähle die PDFs zum Zusammenführen.',
    dropClick: 'Zum Auswählen klicken',
    dropOr: 'oder Dateien irgendwo auf die Seite ziehen',
    dropSupported: 'PDF-Dateien',
    settingsButton: 'Einstellungen',
    mergeButton: 'PDFs zusammenführen', merging: 'Wird zusammengeführt…', moveUp: 'Nach oben', moveDown: 'Nach unten', removeFile: 'Entfernen',
    ...
    dzDropSub: 'Lege PDFs zum Zusammenführen ab',
  ...
  es: {
    ...
    uploadSubtitle: 'Elige los PDF que quieres unir.',
    ...
    mergeButton: 'Unir PDF', merging: 'Uniendo…', moveUp: 'Subir', moveDown: 'Bajar', removeFile: 'Quitar',
    ...
    dzDropSub: 'Suelta PDF para unirlos',
