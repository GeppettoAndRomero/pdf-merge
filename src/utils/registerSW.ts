...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/pdf-merge/sw.js, scope=/pdf-merge/）。
    // scope がツールの全 locale ページ（/pdf-merge/, /pdf-merge/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/pdf-merge/sw.js', {
      scope: '/pdf-merge/',
    });
