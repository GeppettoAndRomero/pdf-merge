...
const PRECACHE_URLS = [
  '/pdf-merge/',
  '/pdf-merge/manifest.json',
  '/pdf-merge/icon-192.png',
  '/pdf-merge/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/pdf-merge/manifest.json';
}
